...
<tr>
<th width="20%">Header File</th>
<th>Function and Description</th>
</tr>
<tr>
<td>&lt;iostream&gt;</td>
<td>This file defines the <b>cin, cout, cerr</b> and <b>clog</b> objects, which correspond to the standard input stream, the standard output stream, the un-buffered standard error stream and the buffered standard error stream, respectively.</td> 
</tr>
<tr>
<td>&lt;iomanip&gt;</td>
<td>This file declares services useful for performing formatted I/O with so-called parameterized stream manipulators, such as <b>setw</b> and <b>setprecision</b>.</td> 
</tr>
<tr>
<td>&lt;fstream&gt;</td>
<td>This file declares services for user-controlled file processing. We will discuss about it in detail in File and Stream related chapter.</td> 
</tr>
</table>
...
<br/><br/><br/><br/><br/>
<a href="C++References.jsp">Previous</a>
<a href="C++DS.jsp">Next</a>
